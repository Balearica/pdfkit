...
class PDFDocument extends stream.Readable {
  constructor(options = {}) {
    ...
    // Start--section copied from https://gist.github.com/GonzaloZiadi/c0b18376da39e6c334410e9e90715ed8
    ...
    // A copy of PDFSecurity.generateFileID that removes CryptoJS MD5.
    const custom_generateFileID = info => {
      ...
      return wordArrayToBuffer(custom_hashCode(infoStr));
    };
    this._id = custom_generateFileID(this.info); // Initialize security settings

    // End--section copied from https://gist.github.com/GonzaloZiadi/c0b18376da39e6c334410e9e90715ed8
